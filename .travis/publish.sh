...
GIT_REPOSITORY='git@github.com:ldez/atom-language-gitattributes.git'
...
## Loading SSH key
echo "Loading key..."
openssl aes-256-cbc -K "$encrypted_8c8804f0a0a3_key" -iv "$encrypted_8c8804f0a0a3_iv" -in .travis/${SSH_KEY_NAME}.enc -out ~/.ssh/${SSH_KEY_NAME} -d
eval "$(ssh-agent -s)"
